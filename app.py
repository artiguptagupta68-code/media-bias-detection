...
MODEL_NAME = "arti-gupta/media-bias-distilbert"  # Hugging Face repo
LORA_PATH = "arti-gupta/media-bias-lora"         # LoRA adapter repo
HF_TOKEN = "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"                        # if private repo
