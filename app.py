...
import re
MODEL_NAME = "arti-gupta/media-bias-lora-distilbert"  # replace with your HF repo name

# If private repo
HF_TOKEN = "hf_xxx_your_token_here"  # optional if private
